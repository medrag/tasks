...
var TaskService = /** @class */ (function () {
    function TaskService(httpClient) {
        ...
        this.onAddTaskEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    }
...
var TasksAddComponent = /** @class */ (function () {
    ...
    TasksAddComponent.prototype.saveTask = function (event) {
        var _this = this;
        var task = new _task_model__WEBPACK_IMPORTED_MODULE_2__["Task"](event.target.value, this.getTodayAsString(), false);
        this.taskService.addTask(task).subscribe(function (newTask) {
            //clear the input
            _this.taskValue = ' ';
            _this.taskService.onAddTaskEvent.emit(newTask);
        });
    };
...
var TasksListComponent = /** @class */ (function () {
    ...
    TasksListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.taskService.getTasks().subscribe(function (tasks) { _this.tasks = tasks; }, function (error) { return console.log(error); });
        this.taskService.onAddTaskEvent.subscribe(function (newTask) { return _this.tasks.push(newTask); });
    };
...
module.exports = __webpack_require__(/*! C:\Users\ragui\IdeaProjects\tasks\src\main\frontend\src\main.ts */"./src/main.ts");
